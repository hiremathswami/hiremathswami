# 👋 Hi, I’m Rohan Hiremathswami

🚀 **Full-Stack Developer | AI & Data Enthusiast**  
🎓 BCA Graduate | Aspiring MCA (AI Focus)  
📊 Google Data Analytics Certified  
☁️ AWS – Introduction to Generative AI Certified  

I build **scalable web applications** and **intelligent, data-driven systems**, combining modern backend engineering with AI/ML concepts.  
Currently focused on **Full-Stack + AI integration** for real-world applications.

---

## 🧠 What I Do
- Build full-stack web applications (MERN / MVC architecture)
- Design REST APIs & backend systems
- Work with databases (SQL & NoSQL)
- Apply data analytics & machine learning concepts
- Explore Generative AI & AI-powered features

---

## 🌐 Connect With Me
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?logo=linkedin&logoColor=white)](https://www.linkedin.com/in/rohan-hiremathswami)
[![Email](https://img.shields.io/badge/Email-D14836?logo=gmail&logoColor=white)](mailto:rohanhiremathswami73@gmail.com)
...
## 📌 Featured Project
🔹 **Helios Watch Store** – Full-Stack E-Commerce Platform  
